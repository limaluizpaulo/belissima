    ...
    <div className="event-info-container" id="event-overview">
      ...
      <div className="event-benefits">
        <div className="benefits-left">
          <ul>
            <li className="list">
              <img src="/marca-de-verificacao.png" alt="Ícone de tique" /> Um
              kit home care
            </li>
            <li>
              <img src="/marca-de-verificacao.png" alt="Ícone de tique" />{" "}
              Orientação de quem já alcançou o sucesso
            </li>
            <li>
              <img src="/marca-de-verificacao.png" alt="Ícone de tique" />
              Acessos os melhores produtos profissionais com preços de fábrica
            </li>
          </ul>
        </div>
        ...
        <div className="benefits-right">
          <ul>
            ...
            <li>
              <img src="/marca-de-verificacao.png" alt="Ícone de tique" />{" "}
              Concorra a uma cadeira profissional
            </li>
          </ul>
        </div>
      </div>
